...
SECRET_KEY = 'yd96(0n$%my@^#fu)j@pv)j#u1q-$0_@xzz_3m$&kccw%e+oj3'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
# TODO add conditional settings based on development or production
HTTP_TYPE = 'http'
DOMAIN = '127.0.0.1:8000'
APPLICATION_NAME = 'Student Design'
